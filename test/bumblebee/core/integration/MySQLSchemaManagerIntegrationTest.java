...
public class MySQLSchemaManagerIntegrationTest extends SQLIntegrationTestBase {
	...
	@Test public void shouldReadData() throws BusinessException {
	...
	@Test public void shouldCacheLoadedData() throws BusinessException {
		MySQLSchemaManager schemaManager = new MySQLSchemaManager(getFakeConnection());
	...
	@Test public void shouldHonorSchemaName() throws BusinessException {
		MySQLSchemaManager schemaManager = new MySQLSchemaManager(getFakeConnection());
